...
# "V" 2. Add new function for saving the event list result
# 3. Add new function for watching completed video (load video and txt , and we can see the whole result of this video)
